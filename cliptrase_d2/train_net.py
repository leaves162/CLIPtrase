...
from cliptrase import (
    MaskFormerSemanticDatasetMapper,
    # COCOPanopticNewBaselineDatasetMapper,
    SemanticSegmentorWithTTA,
    add_our_config,
)
from cliptrase.data import build_detection_test_loader, build_detection_train_loader
from cliptrase.utils import WandbWriter, setup_wandb

# https://github.com/MendelXu/SAN/blob/main/train_net.py
...
class Trainer(DefaultTrainer):
    ...
    def build_optimizer(cls, cfg, model):
        ...
        logger = logging.getLogger("cliptrase")
...
def setup(args):
    ...
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="cliptrase")
    return cfg

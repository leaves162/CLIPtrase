...
from .origin_clip import CLIP
from .utils import get_labelset_from_dataset

# https://github.com/MendelXu/SAN/blob/main/san/model/clip_utils/classifier.py
...
class PredefinedOvClassifier(nn.Module):
    ...
    @property
    def dtype(self):
        return self.transformer.resblocks[0].attn.in_proj_bias.dtype
